...
def gen_glavni(imena_upita):
    ...
    L += ['    Beleska "> meni"',
          ...
          '    Beleska ' + q('> provera (otvara se svaki upit i izveštaj)'),
          '    Beleska ProveriSve()',
          ...
          '           ' + q('upozorenja pri kreiranju: ') + ' & gGreske & vbCrLf & vbCrLf & _',
          '           ' + q('PROVERA') + ' & vbCrLf & _',
          '           ' + q('u redu: ') + ' & gOk & vbCrLf & _',
          '           ' + q('prazno (radi, ali bez podataka): ') + ' & gPrazno & vbCrLf & _',
          '           ' + q('greška: ') + ' & gLose & vbCrLf & vbCrLf & _',
          '           ' + q('Detaljan spisak: Ctrl+G (Immediate prozor)'
                            ' ili procedura Dnevnik.') + ' & vbCrLf & _',
